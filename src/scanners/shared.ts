...
export const normalizePath = (path: string): string => path.split(sep).join('/');

export const getRelative = (from: string, to: string): string => {
...
export const getFileContent = (file: string): Promise<string> => pReadFile(file, 'utf8');
